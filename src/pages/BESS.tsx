...
export default function SolarEPC() {
  ...
  return (
    <main className="pt-24 bg-white overflow-hidden">
      ...
      <section className="relative py-24 px-6 lg:px-12 bg-[#1A1A1A]">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-6xl lg:text-8xl font-black text-white tracking-tighter leading-[0.9] mb-8">
            BESS <span className="text-[#6bc73a]">Solutions.</span>
          </h1>
      ...
      <section className="py-24 px-6 lg:px-12 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Peak Shaving", desc: "Large scale solar farms designed for grid-tie stability." },
              { title: "Frequency Regulation", desc: "Optimizing industrial roof space for captive consumption." },
              { title: "Microgrids", desc: "Innovative water-based installations to save land and reduce evaporation." }
            ].map((s, i) => (
      ...
      {/* PHOTO 4: Step-by-Step Procedure */}
      <section className="py-24 px-6 lg:px-12 bg-[#1A1A1A] text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              { step: "01", t: "Load Profile Analysis", d: "Detailed technical & financial viability studies." },
              { step: "02", t: "Capacity Sizing", d: "Custom structural and electrical blueprints." },
              { step: "03", t: "Battery Setup", d: "Global sourcing of high-efficiency modules." },
              { step: "04", t: "Execution", d: "Rapid on-site installation and grid testing." }
            ].map((item, i) => (
