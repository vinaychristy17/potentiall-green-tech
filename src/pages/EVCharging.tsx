      ...
      <section className="relative py-24 px-6 lg:px-12 bg-[#1A1A1A]">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-6xl lg:text-8xl font-black text-white tracking-tighter leading-[0.9] mb-8">
            EV <span className="text-[#6bc73a]">Infrastructure.</span>
          </h1>
      ...
      <section className="py-24 px-6 lg:px-12 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Fast DC Hubs", desc: "Large scale solar farms designed for grid-tie stability." },
              { title: "Fleet Management", desc: "Optimizing industrial roof space for captive consumption." },
              { title: "Smart Billing", desc: "Innovative water-based installations to save land and reduce evaporation." }
            ].map((s, i) => (
      ...
      <section className="py-24 px-6 lg:px-12 bg-[#1A1A1A] text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              { step: "01", t: "Network Planning", d: "Detailed technical & financial viability studies." },
              { step: "02", t: "Hardware Setup", d: "Custom structural and electrical blueprints." },
              { step: "03", t: "Software Integration", d: "Global sourcing of high-efficiency modules." },
              { step: "04", t: "CMS Launch", d: "Rapid on-site installation and grid testing." }
            ].map((item, i) => (
