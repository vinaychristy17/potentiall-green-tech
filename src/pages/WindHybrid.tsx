      ...
      <section className="relative py-24 px-6 lg:px-12 bg-[#1A1A1A]">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-6xl lg:text-8xl font-black text-white tracking-tighter leading-[0.9] mb-8">
            Wind & <span className="text-[#6bc73a]">Hybrid.</span>
          </h1>
      ...
      <section className="py-24 px-6 lg:px-12 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Co-located Plants,", desc: "Large scale solar farms designed for grid-tie stability." },
              { title: "Hybrid Inverters", desc: "Optimizing industrial roof space for captive consumption." },
              { title: "AC/DC Coupling", desc: "Innovative water-based installations to save land and reduce evaporation." }
            ].map((s, i) => (
      ...
      <section className="py-24 px-6 lg:px-12 bg-[#1A1A1A] text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              { step: "01", t: "Site Selection", d: "Detailed technical & financial viability studies." },
              { step: "02", t: "Resource Mapping", d: "Custom structural and electrical blueprints." },
              { step: "03", t: "Hybrid Integration", d: "Global sourcing of high-efficiency modules." },
              { step: "04", t: "Grid Tie", d: "Rapid on-site installation and grid testing." }
            ].map((item, i) => (
